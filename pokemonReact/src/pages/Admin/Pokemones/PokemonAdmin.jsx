...
const DetallePokemon = () => {
    ...
    const eliminarPokemon = () => {
        const confirmar = window.confirm("¿Estás seguro de que deseas eliminar este Pokémon?");
        if (!confirmar) return;
        axios.delete(`http://localhost:3000/pokemons/${id}`)
            ...
            .catch(error => console.error('Error al eliminar el Pokémon:', error));
    };
        ...
        <>
            ...
            <Container className="mt-4">
                <Card className="p-3 fold-big mb-4">
                    <h2 className="text-center mb-4">Herramientas Admin</h2>
                    <Row className="justify-content-center">
                        <Col xs={6} sm={4} md={2} className="mb-2">
                            <Button className="btn-tipo w-100" variant="outline-danger" onClick={() => navigate(`/pokemones/${id}/foto`)}>
                                Subir Imagen
                            </Button>
                        </Col>
                        <Col xs={6} sm={4} md={2} className="mb-2">
                            <Button className="btn-tipo w-100" variant="outline-danger" onClick={() => navigate(`/pokemones/${id}/editar`)}>
                                Editar Datos
                            </Button>
                        </Col>
                        <Col xs={6} sm={4} md={2} className="mb-2">
                            <Button className="btn-tipo w-100" variant="outline-danger" onClick={() => navigate(`/pokemones/${id}/tipos`)}>
                                Editar Tipo
                            </Button>
                        </Col>
                        <Col xs={6} sm={4} md={2} className="mb-2">
                            <Button className="btn-tipo w-100" variant="outline-danger" onClick={() => navigate(`/pokemones/${id}/Habilidades`)}>
                                Editar Habilidad
                            </Button>
                        </Col>
                        <Col xs={6} sm={4} md={2} className="mb-2">
                            <Button className="btn-tipo w-100" variant="outline-danger" onClick={() => navigate(`/pokemones/${id}/Estadisticas`)}>
                                Editar Estadística
                            </Button>
                        </Col>
                        <Col xs={6} sm={4} md={2} className="mb-2">
                            <Button className="btn-tipo w-100" variant="outline-danger" onClick={() => navigate(`/pokemones/${id}/Evoluciones`)}>
                                Editar Evolución
                            </Button>
                        </Col>
                        <Col xs={6} sm={4} md={2} className="mb-2">
                            <Button className="btn-tipo w-100" variant="outline-danger" onClick={eliminarPokemon}>
                                Eliminar Pokémon
                            </Button>
                        </Col>
                    </Row>
                        ...
                        <Col md={8}>
                            <Card className="p-3 fold-sub-card fold-tipo">
                                <Card.Body>
                                    ...
                                    <Row className="mb-3">
                                        <Col xs={12}><h5>Nombre: <span className="data-box color no-bold">{pokemon.nombre}</span></h5></Col>
                                    </Row>
                                    <Row className="mb-3">
